...
namespace DataAccessLayer
{
    public class DALOgrenci
    {
        ...
        {
            SqlCommand komut1 = new SqlCommand("insert into TBLOGRENCI (OGRAD, OGRSOYAD," +
                "OGRNUMARA,OGRFOTO,OGRSIFRE) values (@p1,@p2,@p3,@p4,@p5)", Baglanti.bgl);
        ...
        {
            List<EntityOgrenci> degerler = new List<EntityOgrenci>();
            SqlCommand komut4 = new SqlCommand("Select * From TBLOGRENCI " +
                "Where OGRID=@P1", Baglanti.bgl);
        ...
        {
            SqlCommand komut5 = new SqlCommand("Update TBLOGRENCI set OGRAD=@P1," +
